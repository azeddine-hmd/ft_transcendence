...
export default function Main({isopen} :any) {
    return (
        <>
            ...
            <div className={`gif bg-slate-400 w-[70%] h-screen rounded-r-3xl relative`} style={{borderRadius:"0 123px 123px 0",background:isopen? "black":"none"}}>
            {/* {isopen ? null :<div className="backcolor backgroundblack absolute top-0 left-0 w-full h-screen"></div>} */}
